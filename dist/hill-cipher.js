...
var HillCipher = /** @class */ (function () {
    function HillCipher(option) {
        ...
        var size = ~~Math.sqrt(keyLength);
        var keyArr = stringToTwoDimArray(option.key, size, size, template);
        ...
        // get multiplier
        var scalar = ~~keyMatrix.multiplyMatrix(inverse).at(0, 0) % mod;
